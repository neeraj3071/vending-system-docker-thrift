...
class BeveragePreferenceServiceIfSingletonFactory : virtual public BeveragePreferenceServiceIfFactory {
 public:
  BeveragePreferenceServiceIfSingletonFactory(const ::apache::thrift::stdcxx::shared_ptr<BeveragePreferenceServiceIf>& iface) : iface_(iface) {}
 ...
 protected:
  ::apache::thrift::stdcxx::shared_ptr<BeveragePreferenceServiceIf> iface_;
};
...
class BeveragePreferenceService_getBeverage_args {
 public:
  ...
  virtual ~BeveragePreferenceService_getBeverage_args() throw();
...
class BeveragePreferenceService_getBeverage_pargs {
 public:
  ...
  virtual ~BeveragePreferenceService_getBeverage_pargs() throw();
...
class BeveragePreferenceService_getBeverage_result {
 public:
  ...
  virtual ~BeveragePreferenceService_getBeverage_result() throw();
  std::string success;
...
class BeveragePreferenceService_getBeverage_presult {
 public:
  ...
  virtual ~BeveragePreferenceService_getBeverage_presult() throw();
  std::string* success;
...
class BeveragePreferenceServiceClient : virtual public BeveragePreferenceServiceIf {
 public:
  BeveragePreferenceServiceClient(apache::thrift::stdcxx::shared_ptr< ::apache::thrift::protocol::TProtocol> prot) {
    setProtocol(prot);
  }
  BeveragePreferenceServiceClient(apache::thrift::stdcxx::shared_ptr< ::apache::thrift::protocol::TProtocol> iprot, apache::thrift::stdcxx::shared_ptr< ::apache::thrift::protocol::TProtocol> oprot) {
...
class BeveragePreferenceServiceProcessor : public ::apache::thrift::TDispatchProcessor {
 ...
 public:
  BeveragePreferenceServiceProcessor(::apache::thrift::stdcxx::shared_ptr<BeveragePreferenceServiceIf> iface) :
    iface_(iface) {
...
class BeveragePreferenceServiceProcessorFactory : public ::apache::thrift::TProcessorFactory {
 public:
  BeveragePreferenceServiceProcessorFactory(const ::apache::thrift::stdcxx::shared_ptr< BeveragePreferenceServiceIfFactory >& handlerFactory) :
      handlerFactory_(handlerFactory) {}

  ::apache::thrift::stdcxx::shared_ptr< ::apache::thrift::TProcessor > getProcessor(const ::apache::thrift::TConnectionInfo& connInfo);

 protected:
  ::apache::thrift::stdcxx::shared_ptr< BeveragePreferenceServiceIfFactory > handlerFactory_;
};

class BeveragePreferenceServiceMultiface : virtual public BeveragePreferenceServiceIf {
 public:
  BeveragePreferenceServiceMultiface(std::vector<apache::thrift::stdcxx::shared_ptr<BeveragePreferenceServiceIf> >& ifaces) : ifaces_(ifaces) {
  }
  virtual ~BeveragePreferenceServiceMultiface() {}
 protected:
  std::vector<apache::thrift::stdcxx::shared_ptr<BeveragePreferenceServiceIf> > ifaces_;
  BeveragePreferenceServiceMultiface() {}
  void add(::apache::thrift::stdcxx::shared_ptr<BeveragePreferenceServiceIf> iface) {
...
class BeveragePreferenceServiceConcurrentClient : virtual public BeveragePreferenceServiceIf {
 public:
  BeveragePreferenceServiceConcurrentClient(apache::thrift::stdcxx::shared_ptr< ::apache::thrift::protocol::TProtocol> prot) {
    setProtocol(prot);
  }
  BeveragePreferenceServiceConcurrentClient(apache::thrift::stdcxx::shared_ptr< ::apache::thrift::protocol::TProtocol> iprot, apache::thrift::stdcxx::shared_ptr< ::apache::thrift::protocol::TProtocol> oprot) {
    setProtocol(iprot,oprot);
  }
 private:
  void setProtocol(apache::thrift::stdcxx::shared_ptr< ::apache::thrift::protocol::TProtocol> prot) {
