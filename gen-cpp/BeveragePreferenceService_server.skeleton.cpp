...
int main(int argc, char **argv) {
  int port = 9090;
  ::apache::thrift::stdcxx::shared_ptr<BeveragePreferenceServiceHandler> handler(new BeveragePreferenceServiceHandler());
  ::apache::thrift::stdcxx::shared_ptr<TProcessor> processor(new BeveragePreferenceServiceProcessor(handler));
