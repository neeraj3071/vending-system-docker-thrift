...
class OrderBeverageServiceIfSingletonFactory : virtual public OrderBeverageServiceIfFactory {
 public:
  OrderBeverageServiceIfSingletonFactory(const ::apache::thrift::stdcxx::shared_ptr<OrderBeverageServiceIf>& iface) : iface_(iface) {}
 ...
 protected:
  ::apache::thrift::stdcxx::shared_ptr<OrderBeverageServiceIf> iface_;
};
...
class OrderBeverageService_PlaceOrder_args {
 public:
  ...
  virtual ~OrderBeverageService_PlaceOrder_args() throw();
  int64_t city;
...
class OrderBeverageService_PlaceOrder_pargs {
 public:
  ...
  virtual ~OrderBeverageService_PlaceOrder_pargs() throw();
  const int64_t* city;
...
class OrderBeverageService_PlaceOrder_result {
 public:
  ...
  virtual ~OrderBeverageService_PlaceOrder_result() throw();
  std::string success;
  ServiceException se;
...
class OrderBeverageService_PlaceOrder_presult {
 public:
  ...
  virtual ~OrderBeverageService_PlaceOrder_presult() throw();
  std::string* success;
  ServiceException se;
...
class OrderBeverageServiceClient : virtual public OrderBeverageServiceIf {
 public:
  OrderBeverageServiceClient(apache::thrift::stdcxx::shared_ptr< ::apache::thrift::protocol::TProtocol> prot) {
    setProtocol(prot);
  }
  OrderBeverageServiceClient(apache::thrift::stdcxx::shared_ptr< ::apache::thrift::protocol::TProtocol> iprot, apache::thrift::stdcxx::shared_ptr< ::apache::thrift::protocol::TProtocol> oprot) {
...
class OrderBeverageServiceProcessor : public ::apache::thrift::TDispatchProcessor {
 ...
 public:
  OrderBeverageServiceProcessor(::apache::thrift::stdcxx::shared_ptr<OrderBeverageServiceIf> iface) :
    iface_(iface) {
...
class OrderBeverageServiceProcessorFactory : public ::apache::thrift::TProcessorFactory {
 public:
  OrderBeverageServiceProcessorFactory(const ::apache::thrift::stdcxx::shared_ptr< OrderBeverageServiceIfFactory >& handlerFactory) :
      handlerFactory_(handlerFactory) {}

  ::apache::thrift::stdcxx::shared_ptr< ::apache::thrift::TProcessor > getProcessor(const ::apache::thrift::TConnectionInfo& connInfo);

 protected:
  ::apache::thrift::stdcxx::shared_ptr< OrderBeverageServiceIfFactory > handlerFactory_;
};

class OrderBeverageServiceMultiface : virtual public OrderBeverageServiceIf {
 public:
  OrderBeverageServiceMultiface(std::vector<apache::thrift::stdcxx::shared_ptr<OrderBeverageServiceIf> >& ifaces) : ifaces_(ifaces) {
  }
  virtual ~OrderBeverageServiceMultiface() {}
 protected:
  std::vector<apache::thrift::stdcxx::shared_ptr<OrderBeverageServiceIf> > ifaces_;
  OrderBeverageServiceMultiface() {}
  void add(::apache::thrift::stdcxx::shared_ptr<OrderBeverageServiceIf> iface) {
...
class OrderBeverageServiceConcurrentClient : virtual public OrderBeverageServiceIf {
 public:
  OrderBeverageServiceConcurrentClient(apache::thrift::stdcxx::shared_ptr< ::apache::thrift::protocol::TProtocol> prot) {
    setProtocol(prot);
  }
  OrderBeverageServiceConcurrentClient(apache::thrift::stdcxx::shared_ptr< ::apache::thrift::protocol::TProtocol> iprot, apache::thrift::stdcxx::shared_ptr< ::apache::thrift::protocol::TProtocol> oprot) {
    setProtocol(iprot,oprot);
  }
 private:
  void setProtocol(apache::thrift::stdcxx::shared_ptr< ::apache::thrift::protocol::TProtocol> prot) {
