...
class UpdateWeatherServiceIfSingletonFactory : virtual public UpdateWeatherServiceIfFactory {
 public:
  UpdateWeatherServiceIfSingletonFactory(const ::apache::thrift::stdcxx::shared_ptr<UpdateWeatherServiceIf>& iface) : iface_(iface) {}
 ...
 protected:
  ::apache::thrift::stdcxx::shared_ptr<UpdateWeatherServiceIf> iface_;
};
...
class UpdateWeatherService_UpdateWeather_args {
 public:
  ...
  virtual ~UpdateWeatherService_UpdateWeather_args() throw();
  int64_t city;
  WeatherType::type w;
...
class UpdateWeatherService_UpdateWeather_pargs {
 public:
  ...
  virtual ~UpdateWeatherService_UpdateWeather_pargs() throw();
  const int64_t* city;
...
class UpdateWeatherService_UpdateWeather_result {
 public:
  ...
  virtual ~UpdateWeatherService_UpdateWeather_result() throw();
...
class UpdateWeatherService_UpdateWeather_presult {
 public:
  ...
  virtual ~UpdateWeatherService_UpdateWeather_presult() throw();
...
class UpdateWeatherServiceClient : virtual public UpdateWeatherServiceIf {
 public:
  UpdateWeatherServiceClient(apache::thrift::stdcxx::shared_ptr< ::apache::thrift::protocol::TProtocol> prot) {
    setProtocol(prot);
  }
  UpdateWeatherServiceClient(apache::thrift::stdcxx::shared_ptr< ::apache::thrift::protocol::TProtocol> iprot, apache::thrift::stdcxx::shared_ptr< ::apache::thrift::protocol::TProtocol> oprot) {
...
class UpdateWeatherServiceProcessor : public ::apache::thrift::TDispatchProcessor {
 ...
 public:
  UpdateWeatherServiceProcessor(::apache::thrift::stdcxx::shared_ptr<UpdateWeatherServiceIf> iface) :
    iface_(iface) {
...
class UpdateWeatherServiceProcessorFactory : public ::apache::thrift::TProcessorFactory {
 public:
  UpdateWeatherServiceProcessorFactory(const ::apache::thrift::stdcxx::shared_ptr< UpdateWeatherServiceIfFactory >& handlerFactory) :
      handlerFactory_(handlerFactory) {}

  ::apache::thrift::stdcxx::shared_ptr< ::apache::thrift::TProcessor > getProcessor(const ::apache::thrift::TConnectionInfo& connInfo);

 protected:
  ::apache::thrift::stdcxx::shared_ptr< UpdateWeatherServiceIfFactory > handlerFactory_;
};

class UpdateWeatherServiceMultiface : virtual public UpdateWeatherServiceIf {
 public:
  UpdateWeatherServiceMultiface(std::vector<apache::thrift::stdcxx::shared_ptr<UpdateWeatherServiceIf> >& ifaces) : ifaces_(ifaces) {
  }
  virtual ~UpdateWeatherServiceMultiface() {}
 protected:
  std::vector<apache::thrift::stdcxx::shared_ptr<UpdateWeatherServiceIf> > ifaces_;
  UpdateWeatherServiceMultiface() {}
  void add(::apache::thrift::stdcxx::shared_ptr<UpdateWeatherServiceIf> iface) {
...
class UpdateWeatherServiceConcurrentClient : virtual public UpdateWeatherServiceIf {
 public:
  UpdateWeatherServiceConcurrentClient(apache::thrift::stdcxx::shared_ptr< ::apache::thrift::protocol::TProtocol> prot) {
    setProtocol(prot);
  }
  UpdateWeatherServiceConcurrentClient(apache::thrift::stdcxx::shared_ptr< ::apache::thrift::protocol::TProtocol> iprot, apache::thrift::stdcxx::shared_ptr< ::apache::thrift::protocol::TProtocol> oprot) {
    setProtocol(iprot,oprot);
  }
 private:
  void setProtocol(apache::thrift::stdcxx::shared_ptr< ::apache::thrift::protocol::TProtocol> prot) {
